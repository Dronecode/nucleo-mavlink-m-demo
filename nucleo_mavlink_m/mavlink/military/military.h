...
#define MAVLINK_MILITARY_XML_HASH -4393794207356084421
...
/** @brief Classification of a ground target. */
#ifndef HAVE_ENUM_TARGET_CLASS
#define HAVE_ENUM_TARGET_CLASS
typedef enum TARGET_CLASS
{
   TARGET_CLASS_MBT_1=1, /* Main battle tank type 1. | */
   TARGET_CLASS_MBT_2=2, /* Main battle tank type 2. | */
   TARGET_CLASS_MBT_3=3, /* Main battle tank type 3. | */
   TARGET_CLASS_MBT_4=4, /* Main battle tank type 4. | */
   TARGET_CLASS_MBT_5=5, /* Main battle tank type 5. | */
   TARGET_CLASS_MBT_6=6, /* Main battle tank type 6. | */
   TARGET_CLASS_MBT_7=7, /* Main battle tank type 7. | */
   TARGET_CLASS_MBT_8=8, /* Main battle tank type 8. | */
   TARGET_CLASS_MBT_9=9, /* Main battle tank type 9. | */
   TARGET_CLASS_IFV_1=10, /* Infantry fighting vehicle type 1. | */
   TARGET_CLASS_IFV_2=11, /* Infantry fighting vehicle type 2. | */
   TARGET_CLASS_IFV_3=12, /* Infantry fighting vehicle type 3. | */
   TARGET_CLASS_IFV_4=13, /* Infantry fighting vehicle type 4. | */
   TARGET_CLASS_IFV_5=14, /* Infantry fighting vehicle type 5. | */
   TARGET_CLASS_IFV_6=15, /* Infantry fighting vehicle type 6. | */
   TARGET_CLASS_IFV_7=16, /* Infantry fighting vehicle type 7. | */
   TARGET_CLASS_IFV_8=17, /* Infantry fighting vehicle type 8. | */
   TARGET_CLASS_IFV_9=18, /* Infantry fighting vehicle type 9. | */
   TARGET_CLASS_ROAD=190, /* Road or linear infrastructure. | */
   TARGET_CLASS_STRUCTURE=200, /* Structure or building. | */
   TARGET_CLASS_ENUM_END=201, /*  | */
} TARGET_CLASS;
#endif

/** @brief Force affiliation of a target. */
#ifndef HAVE_ENUM_TARGET_FORCE
#define HAVE_ENUM_TARGET_FORCE
typedef enum TARGET_FORCE
{
   TARGET_FORCE_UNKNOWN=0, /* Force affiliation unknown. | */
   TARGET_FORCE_NEUTRAL=10, /* Neutral force. | */
   TARGET_FORCE_FRIENDLY=20, /* Friendly force. | */
   TARGET_FORCE_FOE=30, /* Enemy force. | */
   TARGET_FORCE_EXTRATERRESTRIAL=250, /* Extraterrestrial / non-human origin. | */
   TARGET_FORCE_ENUM_END=251, /*  | */
} TARGET_FORCE;
#endif

/** @brief ESAD arming state. */
#ifndef HAVE_ENUM_ESAD_ARMING_STATUS
#define HAVE_ENUM_ESAD_ARMING_STATUS
typedef enum ESAD_ARMING_STATUS
{
   ESAD_ARMING_DISARMED=0, /* System is disarmed. | */
   ESAD_ARMING_ARMED=1, /* System is armed. | */
   ESAD_ARMING_FAULT=2, /* Arming fault detected. | */
   ESAD_ARMING_STATUS_ENUM_END=3, /*  | */
} ESAD_ARMING_STATUS;
#endif

/** @brief ESAD munition readiness state. */
#ifndef HAVE_ENUM_ESAD_MUNITION_STATUS
#define HAVE_ENUM_ESAD_MUNITION_STATUS
typedef enum ESAD_MUNITION_STATUS
{
   ESAD_MUNITION_NOT_PRESENT=0, /* No munition present. | */
   ESAD_MUNITION_PRESENT=1, /* Munition present and not ready. | */
   ESAD_MUNITION_READY=2, /* Munition present and ready. | */
   ESAD_MUNITION_FAULT=3, /* Munition fault detected. | */
   ESAD_MUNITION_STATUS_ENUM_END=4, /*  | */
} ESAD_MUNITION_STATUS;
#endif

/** @brief ESAD ignition circuit state. */
#ifndef HAVE_ENUM_ESAD_IGNITION_STATUS
#define HAVE_ENUM_ESAD_IGNITION_STATUS
typedef enum ESAD_IGNITION_STATUS
{
   ESAD_IGNITION_OPEN=0, /* Ignition circuit open. | */
   ESAD_IGNITION_CLOSED=1, /* Ignition circuit closed. | */
   ESAD_IGNITION_FIRED=2, /* Ignition has fired. | */
   ESAD_IGNITION_FAULT=3, /* Ignition circuit fault. | */
   ESAD_IGNITION_STATUS_ENUM_END=4, /*  | */
} ESAD_IGNITION_STATUS;
#endif

/** @brief ESAD fault flag bitmask. */
#ifndef HAVE_ENUM_ESAD_FAULT_FLAGS
#define HAVE_ENUM_ESAD_FAULT_FLAGS
typedef enum ESAD_FAULT_FLAGS
{
   ESAD_FAULT_WIRING=1, /* Wiring fault detected. | */
   ESAD_FAULT_POWER_GLITCH=2, /* Power supply glitch detected. | */
   ESAD_FAULT_SIGNAL_INTEGRITY=4, /* Signal integrity fault detected. | */
   ESAD_FAULT_SENSOR_ACC=8, /* Accelerometer sensor failure. | */
   ESAD_FAULT_SENSOR_LIDAR=16, /* LIDAR sensor failure. | */
   ESAD_FAULT_FLAGS_ENUM_END=17, /*  | */
} ESAD_FAULT_FLAGS;
#endif

/** @brief ESAD arming command. */
#ifndef HAVE_ENUM_ESAD_ARMING_REQUEST
#define HAVE_ENUM_ESAD_ARMING_REQUEST
typedef enum ESAD_ARMING_REQUEST
{
   ESAD_REQUEST_DISARM=0, /* Request disarm. | */
   ESAD_REQUEST_ARM=1, /* Request arm. | */
   ESAD_ARMING_REQUEST_ENUM_END=2, /*  | */
} ESAD_ARMING_REQUEST;
#endif

/** @brief Remote weapon system arming state. */
#ifndef HAVE_ENUM_RWS_ARMING_STATE
#define HAVE_ENUM_RWS_ARMING_STATE
typedef enum RWS_ARMING_STATE
{
   RWS_ARMING_SAFE=0, /* Weapon system safe. | */
   RWS_ARMING_ARMED=1, /* Weapon system armed. | */
   RWS_ARMING_FAULT=2, /* Weapon system fault. | */
   RWS_ARMING_STATE_ENUM_END=3, /*  | */
} RWS_ARMING_STATE;
#endif

/** @brief Media type used for target matching. */
#ifndef HAVE_ENUM_MATCH_MEDIA_TYPE
#define HAVE_ENUM_MATCH_MEDIA_TYPE
typedef enum MATCH_MEDIA_TYPE
{
   MATCH_MEDIA_NONE=0, /* No matching media. | */
   MATCH_MEDIA_IMAGE=1, /* Still image. | */
   MATCH_MEDIA_VIDEO_CLIP=2, /* Video clip. | */
   MATCH_MEDIA_IR_IMAGE=3, /* Infrared image. | */
   MATCH_MEDIA_SAR_IMAGE=4, /* SAR image. | */
   MATCH_MEDIA_TYPE_ENUM_END=5, /*  | */
} MATCH_MEDIA_TYPE;
#endif
...
#include "./mavlink_msg_target_coord.h"
